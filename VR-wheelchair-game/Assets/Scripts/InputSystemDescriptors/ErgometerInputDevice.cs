...
public struct ErgometerInputDeviceHIDInputReport : IInputStateTypeInfo
{
...
[InitializeOnLoad]
#endif
[InputControlLayout(stateType = typeof(ErgometerInputDeviceHIDInputReport))]
public class ErgometerInputDevice : Gamepad
{
    static ErgometerInputDevice()
    {
        InputSystem.RegisterLayout<ErgometerInputDevice>(
            null,
