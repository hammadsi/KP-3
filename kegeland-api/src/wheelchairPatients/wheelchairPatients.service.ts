...
import { UpdateGameSessionDto, HeartRateDto } from './dto/update-game-session.dto';
...
export class WheelchairPatientsService {
  ...
  async updateWheelchairPatientData(id: string, data: UpdatePhysicalStateDto) {
    ...
    await this.firebaseService.firestore.collection('patients').doc(id).update({
  ...
  async addHeartRateToGameSession(
    ...
    try {
      ...
      timeSeriesDataUpdate['timeSeriesData.heartRates'] =
        firestore.FieldValue.arrayUnion(heartRateUpdate);
  ...
  async updateGameSession(
    ...
    try {
      ...
      const transformedSession = {
        ...
        heartRates:
          gameSession.timeSeriesData.heartRates?.map((hr) => {
        ...
        speeds:
          gameSession.timeSeriesData.speeds?.map((speed) => {
