...
const EditProfilePage = () => {
    ...
    const { wheelchairPatient, loading, updatePatientData } = useWheelchairPatient(authUser?.id);
          ...
          <div style={{marginLeft: '20%', marginRight: '20%'}}>
            <Stack spacing={10} direction="row" mt={6}>
              <FormControl>
                ...
                <Input name="height" type='number' value={updatedData.currentPhysicalState.height} onChange={handleHeightChange} />
              </FormControl>
              <FormControl>
                <FormLabel>Weight</FormLabel>
                <Input name="weight" type='number' value={updatedData.currentPhysicalState.weight} onChange={handleWeightChange} />
              </FormControl>
            </Stack>
            <Stack direction="row" spacing={10} mt={10} justifyContent="center">
              ...
              <Button colorScheme="blue" disabled={!allFilled()} onClick={update}>Submit</Button>
            </Stack>
          </div>
        </Card>
      </>
