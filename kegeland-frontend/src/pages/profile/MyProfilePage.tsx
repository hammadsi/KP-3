    ...
    return (
      <>
        <Card loading={loading} minH="lg">
          ...
          <h2 style={{fontSize: '30px', width: '620px', marginBottom: '0.5em'}}>
            <span style={{borderBottom: '1px solid gray', paddingBottom: '2px'}}>Personal Details</span>
          </h2>
          ...
          <h2 style={{fontSize: '30px', width: '620px', marginBottom: '0.5em', marginTop: '4.5em'}}>
            <span style={{borderBottom: '1px solid gray', paddingBottom: '2px'}}>Current Physical State</span>
          </h2>
          <div style={{width: "50%", float:"left", textAlign: 'right', paddingRight: '20px'}}>
          ...
          <div style={{width: "50%", float:"right", textAlign: 'left', paddingLeft: '20px'}}>
            ...
            <h3>{averageHeartRate || averageHeartRate === 0 ? averageHeartRate : '-'}</h3>
            <h3>{maxWheelchairSpeed || maxWheelchairSpeed === 0 ? maxWheelchairSpeed + ' km/h' : '-'}</h3>
            <h3> {averageWheelchairSpeed ? averageWheelchairSpeed + 'km/h' : '-'} </h3>
          </div>
        </Card>
      </>
    );
